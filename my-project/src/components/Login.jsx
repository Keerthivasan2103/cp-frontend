        ...
        <form onSubmit={handleSubmit} className=''>
          <div className='relative mb-6'>
            <input
              ...
              placeholder=' '
            />
            <label htmlFor="username" className='absolute text-sm text-gray-400 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] left-0 peer-focus:left-0 peer-focus:text-white peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:text-white peer-focus:scale-75 peer-focus:-translate-y-6'>
              Username or email
            </label>
          </div>
          <div className='relative mb-6'>
            <input
              ...
              placeholder=' '
            />
            <label htmlFor="password" className='absolute text-sm text-gray-400 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] left-0 peer-focus:left-0 peer-focus:text-white peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:text-white peer-focus:scale-75 peer-focus:-translate-y-6'>
              Password
            </label>
          </div>
